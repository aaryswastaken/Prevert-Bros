...
if __name__ == "__main__":
    ...
    manager = GameManager(debug=debugFlag)  # Create a new manager
    ...
    manager.addObject(player, hasInput=True, isPlayer=True) # register the player

    ec = manager.run() # run the game
